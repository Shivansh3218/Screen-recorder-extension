...
*/
    ...
    ;
    var Ra = new Qa("OFF",Infinity), Sa = new Qa("WARNING",900), Ta = new Qa("CONFIG",700), Ua = function() {
        this.C = 0;
        this.clear()
    }, Va;
    ...
    var Xa = function(a, b) {
        ...
        if (c)
            return c;
        c = bb(a, b.slice(0, Math.max(b.lastIndexOf("."), 0)));
        var d = new Xa(b,c);
        a.entries[b] = d;
        c.children.push(d);
        return d
...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var I = function(a, b, c) {
      ...
      , Bb = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g
      , Cb = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,"g")
      ...
      , Kb = function(a, b) {
        ...
        a instanceof Pa && a.constructor === Pa ? a = a.R : (za("expected object of type SafeHtml, got '" + a + "' of type " + ia(a)),
    ...
    var fc = /^(\/[a-zA-Z0-9_\-]+)+$/
      ...
      , oc = function(a) {
        ...
        c = 0;
        for (d = gc.length; c < d; ++c)
            gc[c].test(b) && P("invalid_prefix");
        c = rc(a, "k", !0);
        d = rc(a, "am");
        e = rc(a, "rs");
        a = rc(a, "t");
    ...
    var sc = decodeURI("%73cript")
      ...
      , vc = function() {
        var a = M.nonce;
        return void 0 !== a ? a && a === String(a) && a.match(tc) ? a : M.nonce = null : A.querySelector ? (a = A.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(tc) ? M.nonce = a : M.nonce = null) : null : null
    }
      , yc = function(a) {
    ...
    var Ec = function(a) {
      ...
      , Q = function(a, b, c) {
        if (b && "object" === typeof b)
            for (var d in b)
                !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Gc(a[d]) && !Gc(b[d]) ? Q(a[d], b[d]) : b[d] && "object" === typeof b[d] ? (a[d] = Gc(b[d]) ? [] : {},
                Q(a[d], b[d])) : a[d] = b[d])
    }
      , Hc = function(a) {
        if (a && !/^\s+$/.test(a)) {
    ...
    var Xc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//
      ...
      , Zc = function() {
        ...
        a = I(b, "authuser") || null,
        null == a && (a = (a = b.match(Xc)) ? a[1] : null));
        if (null == a)
            return null;
        a = String(a);
        254 < a.length && (a = null);
    ...
    var ad, V, W = void 0, X = function(a) {
        try {
        ...
        if (-1 !== V)
            return Ad(),
            W ? t.JSON.stringify.call(t.JSON, a) : hd(a)
    }, Dd = !Date.prototype.toISOString || "function" !== typeof Date.prototype.toISOString || "1970-01-01T00:00:00.000Z" !== (new Date(0)).toISOString(), Ed = function() {
    ...
    Kd || (Od = 1E6 * (screen.width * screen.width + screen.height),
    Pd = Rd(A.cookie + "|" + A.location + "|" + (new Date).getTime() + "|" + Math.random()),
    Ld = U("random/maxObserveMousemove") || 0,
    0 != Ld && Nb("mousemove", Qd, "add", "at"));
    var Sd = function() {
        var a = M.onl;
        if (!a) {
            a = C();
      ...
      , Td = function(a, b) {
        b = b.onload;
        return "function" === typeof b ? (Sd().a(a, b),
        b) : null
    }
      , Ud = function(a) {
    ...
    var Wd = {
      ...
      , $d = function(a, b, c, d, e) {
        ...
        try {
            ...
            f || (f = (a ? new mb(lb(a)) : va || (va = new mb)).ma("IFRAME"),
            g && (f.onload = function() {
                f.onload = null;
                g.call(this)
            }
        ...
        for (var h in c)
            a = c[h],
            "style" === h && "object" === typeof a ? E(a, f.style) : Xd[h] || f.setAttribute(h, String(a));
      ...
      , pe = function(a) {
        for (var b = C(), c = 0 != a.nodeName.toLowerCase().indexOf("g:"), d = a.attributes.length, e = 0; e < d; e++) {
            var f = a.attributes[e]
              , g = f.name
              , k = f.value;
            0 <= qb.call(ne, g) || c && 0 != g.indexOf("data-") || "null" === k || "specified"in f && !f.specified || (c && (g = g.substr(5)),
            b[g.toLowerCase()] = k)
        }
        a = a.style;
    ...
    var te, ue, ve, we, xe, ye = /(?:^|\s)g-((\S)*)(?:$|\s)/, ze = {
        plusone: !0,
        autocomplete: !0,
        profile: !0,
        signin: !0,
    ...
    var Ae = function(a, b) {
      ...
      , Be = function(a, b, c, d) {
        ...
        for (f = 0; f < e.length; f++) {
            ...
            k && (ze[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != yb(pe(g)).length) && (g.setAttribute("data-gapiscan", !0),
            B(c, k, []).push(g))
        }
        if (b)
            for (var q in c)
    ...
    var Ee = function(a, b) {
      ...
      , Fe = function(a, b, c, d, e, f) {
        ...
        case 1:
            if (b.parentNode) {
                ...
                g = b = k;
                ae.test(b) && (g = U("iframes/" + g.substring(1) + "/url"),
                F(!!g, "Unknown iframe url config for - " + b));
                k = Kb(A, g.replace(be, de));
                b = c.ownerDocument || A;
                h = 0;
                do
                    g = f.id || ["I", Yd++, "_", (new Date).getTime()].join("");
      ...
      , re = function(a, b) {
        ...
        if (d) {
            ...
            Sc.log("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
    };
    B(H, "platform", {}).go = Ce;
    De = function(a) {
    ...
    var Ye = "https:" === window.location.protocol
      ...
      , af = function() {
        ...
        Ze.iterate(function(c, d) {
            0 === c.indexOf("G_AUTHUSER_") && (c = $e(c.substring(11)),
